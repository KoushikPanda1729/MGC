...
const defaultFaqs = [
  {
    ...
    answer:
      "Manobikash GUIDE Centre, established in <strong class='text-foreground font-bold'>2018</strong>, is a trusted educational institute in Medinipur offering school tuition, spoken English training, skill development classes, and career guidance for students of all levels.",
  },
  {
    id: "faq-2",
